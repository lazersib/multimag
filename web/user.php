...
try
{
	...
	try{
		...
		if($doc){
			...
			if($doc_data['type']==3)		$document->PrintForm('int:schet');
			else if($doc_data['type']==2)		$document->PrintForm('int:nak');
