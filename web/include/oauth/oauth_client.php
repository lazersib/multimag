...
class oauth_client {
    ...
    /// URL of the OAuth server to redirect the browser so the user can grant access to your application.
    var $pin_dialog_url = '';
    /// URL of the OAuth server to redirect the browser so the user can grant access
    /// to your application when offline access is requested.
    var $offline_dialog_url = '';
    /// Value of the pin code for pin based authorization.
    var $pin = '';
    /// Pass the OAuth session state in a variable with a different name to work around implementation
    /// bugs of certain OAuth servers
    ...
    var $realm = '';
    /// Specify whether it will be necessary to call the API when the user is not present 
    /// and the server supports renewing expired access tokens using refresh tokens.
    var $offline = false;
    ...
    ///Option to determine if the original response for the access token request should be stored
    /// in the access_token_response variable.
    var $store_access_token_response = false;
    ///Option to determine if the requests to obtain a new access token should use authentication 
    /// to pass the application client ID and secret.
