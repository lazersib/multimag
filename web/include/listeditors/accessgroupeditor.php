...
class AccessGroupEditor extends \ListEditor {

    public function __construct($db_link) {
        parent::__construct($db_link);
        $this->print_name = 'Группы привилегий пользователей';
        $this->table_name = 'users_grouplist';
    }
    ...
    //protected function getFieldName($data) {
