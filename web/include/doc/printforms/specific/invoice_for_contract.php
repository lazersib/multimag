...
class invoice_for_contract extends \doc\printforms\iPrintFormPdf {
    ...
    public function make() {
        ...
        if(@$dop_data['warranty_time']) {
            $this->pdf->RowIconv(['Гарантийный срок на товар', @$dop_data['warranty_time']
                . " дней с момента подписания сторонами Акта приема-передачи товара"]);
        }
