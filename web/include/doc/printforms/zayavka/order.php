...
class invoice extends \doc\printforms\iPrintFormPdf {
    ...
    public function make() {
        ...
        $this->pdf->SetFont('', '', 10);
        $text = "Внимание!"
            . " Оплата данного заказа означает согласие с условиями поставки товара."
        ...
        $text = 'Заказ действителен в течение трёх банковских дней!';
        ...
        $text = 'Заказ № '.$doc_data['altnum'].' от '.date("d.m.Y", $doc_data['date']);
        $this->addHeader($text);
