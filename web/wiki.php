...
if($p=="")
{
	if(!isAccess('articles','view'))	throw new AccessException("");
...
else
{
	...
	if(@$nxt=mysql_fetch_row($res))
	{
		...
		else
		{
			...
			{
				if(!isAccess('articles','edit'))	throw new AccessException("");
				$text=rcv('text');
	...
	else
	{
		...
		else
		{
			...
			{
				if(!isAccess('articles','create'))	throw new AccessException("");
				$text=rcv('text');
