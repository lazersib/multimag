...
$actions=array(
    ...
    'apply'=>'Проведение', 
    'cancel'=>'Отмена', 
    'today_apply'=>'Проведение сев.', 
    'today_cancel'=>'Отмена сев.',
    
    'forcecancel'=>'П.отмена',
    'printna'=>'Печать непроведённого',
    
    'read'=>'Чтение', 'write'=>'Запись', 'save'=>'Сохранение',  
    
      'exec'=>'Выполнение', 'redirect'=>'Перенаправление' );
