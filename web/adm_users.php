...
try {
	...
	WHERE `id`='$id'");
		...
		$tmpl->addContent("<h1 id='page-title'>Информация о пользователе с ID $id</h1>
		<table class='list'>
		<tr><th colspan='2'>Основная информация (<a href='/adm_users.php?mode=ue&amp;id=$id'>править</a>)</th></tr>
		...
		<form action='/adm_users.php'>
		<input type='hidden' name='mode' value='we'>
		...
		<form action='/adm_users.php'>
		<input type='hidden' name='mode' value='ue'>
		<input type='hidden' name='id' value='$user_id'>
		<input type='hidden' name='save' value='1'>
		<table class='list'>
