...
function userinfo($userid,$kinf="")
{
    ...
    if($nxt=mysql_fetch_row($res))
    {
        ...
        if($nxt[1]) echo"��������<br>";
        if($nxt[3]) echo"�� �����<br>";
        if($userid==@$kinf[4]) echo"��������� �������<br>";
        if(@$nx[0]>0) echo"���������: $nx[0]<br>";
        echo"</div>";
...
top("�����");
    echo"$arights<br>";
echo"<a href='forum.php?mode=new'>����� ����</a> | <a href='text.php?mid=pravilaforuma'>������� ������</a><br>";
...
else if($mode=="lt") // ****************************** ����
{
    ...
    echo"<a href='forum.php'>����� �������</a> -&gt $kinf[1]<br>";
    echo"���� �������:<table cellSpacing=0 cellPadding=2 width='100%' border=0>";
    echo"<tr class=lin0><td>����</a></td><td width=100>�������</td><td width=100>�������</td><td width=100>���������</td></tr>";
...
else if($mode=="vt") // ****************************** ���������
{
    if($tinf[0])
    {
        echo"<a href='forum.php'>����� �������</a> -&gt <a href='forum.php?mode=lt&k=$kinf[0]'>$kinf[1]</a> -&gt $tinf[2]<br>";
        echo"<table cellSpacing=0 cellPadding=2 width='100%' border=0>
        ...
        if($ll) if($tinf[4]==@$GLOBALS['id'])
           $tx.="<div width=100% align=right><a href='forum.php?mode=et&t=$tinf[0]'>�������������</a></div>";
        ...
        while($nx=mysql_fetch_row($res))
        {
            ...
            if($ll) if($nx[3]==@$GLOBALS['id'])
               $tx.="<div width=100% align=right><a href='forum.php?mode=em&m=$nx[0]'>�������������</a></div>";
...
{
    echo"<a href='forum.php'>����� �������</a> -&gt <a href='forum.php?mode=lt&t=$kinf[0]'>$kinf[1]</a> -&gt
...
{
    echo"<a href='forum.php'>����� �������</a> -&gt <a href='forum.php?mode=lt&k=$kinf[0]'>$kinf[1]</a><br>";
    if(forum_rights("forum_createtheme",$arights))
    {
        $tm=time();
	$res=mysql_query("INSERT INTO users_data (id,forum_count) VALUES ('$uid','0')");
...
echo"<br><br><a href='forum.php?mode=new'>����� ����</a> | <a href='text.php?mid=pravilaforuma'>������� ������</a>";
