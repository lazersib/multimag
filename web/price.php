...
else if($mode=="gen")
{
	...
	if($f=="csv")
	{
		...
		<ul>
		<li>OpenOffice Calc (рекомендуется, <a class='wiki_ext' href='http://download.openoffice.org'>скачать программу</a>)</li>
	...
	else if($f=="html")
	{
		...
		$link['opera']="<a class='wiki_ext' href='http://opera.com'>скачать здесь</a>";
		$link['mozilla']="<a class='wiki_ext' href='http://mozilla.com'>скачать здесь</a>";
	...
	else if($f=="pdf")
	{
		...
		if(!stripos(' '.$ag,'Windows'))
			$list.="<li><a class='wiki_ext' href='http://okular.kde.org/'>Okular (KPDF)</a> (рекомендуется)</li><li>Adobe reader</li><li>KGhostView</li>";	
		if(!stripos(' '.$ag,'Linux'))
			$list.="<li><a class='wiki_ext' href='http://www.foxitsoftware.com/pdf/reader/'>Foxit reader</a> (рекомендуется)</li><li><a class='wiki_ext' herf='http://get.adobe.com/reader/'>Adobe reader</a></li><li>Djvu reader</li>";
	...
	else if($f=='xls')
	{
		...
		<li>OpenOffice Calc (<a class='wiki_ext' href='http://download.openoffice.org'>скачать программу</a>)</li>
