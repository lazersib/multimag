...
$CONFIG['site']['rewrite_enable']	= false;// Разрешить "красивые" ссылки. Необходим mod_recode.
...
$CONFIG['site']['use_product_type_filter'] = false;	// Использовать фильтр по типу продукта.
...
$CONFIG['doc']['restrict_in_noplace']	= false;// Ограничить поступление товара без места хранения
$CONFIG['doc']['tc_nokkt']              = true; // Печатать информацию в товарном чеке *Работа осуществляется без ККТ*
