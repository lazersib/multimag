...
//$CONFIG['ymarket']['local_delivery_cost'] = 1000;	// Стоимость доставки для YML (яндекс-маркет и яндекс-сниппеты)
...
// Настройки склада
$CONFIG['store']['pos_leaf_only']	= true;	// Разрешать создавать наименования только в *листьях* складского дерева
