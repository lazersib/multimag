...
$CONFIG['site']['price_show_vn']	= 0;	// Отображать ли столбец с наименованием производителя в прайсах
...
$CONFIG['service_cdr']['transcode_limit'] = 100;   // Лимит на количество перекодирований записей за раз
